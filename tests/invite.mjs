...
for(const engine of [chromium,webkit]){
 ...
 await page.evaluate(()=>window.denyClipboard=true);await page.locator('.room-code').click();await page.locator('#invite-dialog').waitFor();assert.equal(await page.locator('#invite-link').inputValue(),link);
